...
const events = [
  { title: "Presentation of the new department", time: "Today | 5:00 PM", priority: "up", duration: "4h" },
  { title: "Anna's Birthday", time: "Today | 6:00 PM", priority: "down", duration: "4h" },
  { title: "Ray's Birthday", time: "Tomorrow | 2:00 PM", priority: "down", duration: "4h" },
]
